...
public void createGUI(){
  ...
  numTrucksSlider = new GCustomSlider(controls, 8, 60, 100, 40, "grey_blue");
  ...
  numEmployees = new GCustomSlider(controls, 8, 125, 100, 40, "grey_blue");
  ...
  packagesAdded = new GCustomSlider(controls, 130, 125, 100, 40, "grey_blue");
  ...
  employeeWage = new GCustomSlider(controls, 250, 60, 100, 40, "grey_blue");
  ...
  packagesLabel = new GLabel(controls, 114, 99, 125, 31);
  ...
  wageLabel = new GLabel(controls, 250, 45, 102, 20);
  ...
  packageRequestSpeedSlider = new GCustomSlider(controls, 130, 194, 100, 40, "grey_blue");
  ...
  numShelvesSlider = new GCustomSlider(controls, 130, 60, 100, 40, "grey_blue");
  ...
  shelvesLabel = new GLabel(controls, 130, 45, 80, 20);
  shelvesLabel.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  shelvesLabel.setText("Shelves");
  shelvesLabel.setOpaque(false);
  gasPriceSlider = new GCustomSlider(controls, 250, 125, 100, 40, "grey_blue");
